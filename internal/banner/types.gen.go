...
// DeleteBannerJSONBody defines parameters for DeleteBanner.
type DeleteBannerJSONBody = []int
...
// DeleteBannerJSONRequestBody defines body for DeleteBanner for application/json ContentType.
type DeleteBannerJSONRequestBody = DeleteBannerJSONBody
